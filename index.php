      ...
      <body class="skin-black">
        ...
        <header class="header">
            <a href="index.php" class="logo">
                <!-- <img src="img/logo2.png" height="40" width="40" style="margin-bottom: 4px;" />--> PerPusWeb Pro
            </a>
		...
		<b>Selamat Datang di Perpustakaan Berbasis Web (PerPusWeb), untuk login anggota silahkan klik icon user atau klik <a href="login-anggota.php">disini</a></b>
          </div>
            </div>
...
<!-- Data Total Pengunjung -->                        
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="#" target="_blank">Kelompok Perpus</a> 2017
                </div>
            </aside><!-- /.right-side -->
...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      PerPusWeb adalah aplikasi perpustakaan bebasis website yang responsif
      <table>
      <tr>
      <td>No Telepon</td> <td>:</td> <td>0853 6161 5979</td>
      </tr>
      <br />
      <tr>
