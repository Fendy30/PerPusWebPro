...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        $maxpinjam1		= mktime(0,0,0,date("n"),date("j")+4,date("Y"));
                        $kembali		= date("d-m-Y", $maxpinjam);
                        $kembali1		= date("d-m-Y", $maxpinjam1);
                        ?>
                                <!-- </div> -->
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-transaksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" id="kembali" name="kembali" class="form-control" value="<?php echo $kembali;//if($next == 'Minggu') {echo $kembali1;} else {echo $kembali;} ?>" readonly="readonly">
