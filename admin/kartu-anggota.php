...
<?php } ?>
                ...
                <section class="content">
                  ...
                  <thead>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Cetak Kartu Anggota" href="cetak-kartu-anggota.php?kode=<?php echo $data['no_induk']; ?>&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-print"></span></a>
                    </center></td></tr></div>
                 <?php   
              } 
              ?>
